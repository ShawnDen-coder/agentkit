...
Task runner is `just` (via `rust-just`), invoked through uvx. uv workspace; packages live under
`packages/`. Python `>=3.10,<3.14.99`; dev/test on 3.10 (min), CI matrix 3.10–3.14.
